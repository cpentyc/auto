...
$this->title = Yii::t('app', 'Новости компании');
...
<div class="news-index">
    ...
    <?php if($count>0): ?>
        <div class="row" id="newsBig1">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5">
                <h3><?= $models[0]->h1; ?></h3>
                <?= Html::a(Yii::t('app', 'Подробнее'), ['news/view', 'slug'=> $models[0]->slug ]); ?>
            </div>
        </div>
    <?php endif; ?>
    <br />
    <div class="row newsList" >
        ...
        while ($i<6 && $i<$count )
        {
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                ...
                <?= Html::a($models[$i]->h1, ['news/view', 'slug'=> $models[$i]->slug ], ['class' => 'newsLinkTitle']); ?><br />
    ...
    <div class="row" id="newsBig2">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5">
            <h3><?= $models[1]->h1; ?></h3>
            <?= Html::a(Yii::t('app', 'Подробнее'), ['news/view', 'slug'=> $models[1]->slug ]); ?>
        </div>
    </div>
    <?php endif; ?>
    <br />
